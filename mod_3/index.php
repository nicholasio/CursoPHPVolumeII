<html>
	...
	<body>
		...
		$duster->setNPortas(4);
		$duster->setPotencia(166);
		$duster->setVelocidadeMax(220);

		echo "O carro {$duster->nome} tem tração {$duster->getTracao()}, potências de  {$duster->getPotencia()} cv e velocidade máxima de {$duster->getVelocidadeMax()} km/h <br />";
		...
		echo "Poder do Mago é: " . $mg->power . "<br />";

		echo $mg . "<br />";

		unset($mg->power);
		var_dump(isset($mg->power));
